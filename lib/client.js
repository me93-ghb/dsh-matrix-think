...
window.__ModuleLoader__.load({
    ...
    `;
        ...
        function SettingsCard() {
            return React.createElement('li', { className: 'dsh-matrix-think-settings' }, React.createElement('div', { className: 'dsh-matrix-think-settings-copy' }, React.createElement('div', { className: 'dsh-matrix-think-settings-title' }, 'Matrix Think'), React.createElement('div', { className: 'dsh-matrix-think-settings-description' }, 'Turn expanded reasoning into text rain in this browser.')), React.createElement('label', { className: 'dsh-matrix-think-settings-toggle' }, React.createElement('span', null, 'Enabled'), React.createElement('input', {
                type: 'checkbox',
                role: 'switch',
        ...
        function apply(ctx) {
            ctx.effect(() => ctx.slots.inject('settings.plugin.item', () => ctx.slots.register({ name: 'settings.plugin.item', id: 'matrix-think', order: 100 }, SettingsCard)), 'matrix-think: settings card');
            ctx.effect(() => {
